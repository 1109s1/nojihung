...
public class Stest3 {
	...
	public static void main(String[] args) {
		...
		System.out.println("2. 에쎄 스펠셜 골드     5,000원");
		...
		switch (db) {
		case 1 :
			System.out.println(" 에쎄 골든 리프를 구매했습니다. 거스름돈" + (input-6000) + "원을 받으세요");
			break;
		case 2 :
			System.out.println("거스름돈" + (input-5000) + "원을 받으세요");
			break;
		case 3 :
			System.out.println("거스름돈" + (input-4500) + "원을 받으세요");
			break;
		case 4 :
			System.out.println("거스름돈" + (input-4500) + "원을 받으세요");
			break;
